...
def main():
    ...
    NUM_SEEDS = 8
    INPUT_IMAGE_PATH = (
        "datasets/point-force/test/benchmark_multipoke_mass_understanding/skateboard/images/___materialexpskateboard1.png"
    )
    ...
    prompt = "Edit this image by replacing the left skateboard that has a brick on it with a skateboard with no wheels, that doesn't have any brick on it. So, the shadows should look like the board is directly on the ground."
    pause_seconds = 0.01
