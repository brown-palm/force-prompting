...
def sample_from_quadrilateral(corners):
    ...
    # u, v = np.random.choice([0,1]), np.random.choice([0,1]) # for debugging corners
...
def register():
    ...
    quad_corners = np.array([
        [-12.5, -10.0], # upper right,  (x, y)
        [12.5, -10.0],    # upper left,   (x, y)
        [7.0, 4.3],     # bottom left,  (x, y)
        [-7.0, 4.3]     # bottom right, (x, y)
